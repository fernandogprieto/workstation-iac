...
sudo dnf install -y htop btop git jq tmux python3 golang ansible snsible-lint hellcheck bat fzf ripgrep xdg-utils vim curl gnome-keyring libsecret gh gnome-keyring libsecret
